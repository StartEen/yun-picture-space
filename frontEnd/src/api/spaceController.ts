...
/** findCreateSpace GET /api/space/findCreateCount */
export async function findCreateSpaceUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.findCreateSpaceUsingGETParams,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseBoolean_>('/api/space/findCreateCount', {
    method: 'GET',
    params: {
      ...params,
    },
