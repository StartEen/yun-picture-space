...
/** batchEditPictureMetadata POST /api/picture/edit/batch/tagAndCategory */
export async function batchEditPictureMetadataUsingPost(
  body: API.PictureEditByBatchRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseBoolean_>('/api/picture/edit/batch/tagAndCategory', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** listPictureVoByPageWithRedisAndCaffeine POST /api/picture/list/page/vo/redisAndCaffeine */
export async function listPictureVoByPageWithRedisAndCaffeineUsingPost(
  body: API.PictureQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePagePictureVo_>('/api/picture/list/page/vo/redisAndCaffeine', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
